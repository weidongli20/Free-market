...
// you must modify this to be compatible with the FreeMarket contract
contract fmAuction {
    ...
    function bid(address payable sender) public payable {
        ...
        require(!ended, "End-Sale has already been called.");
    ...
    function auctionEnd() public {
        ...
        require(!ended, "End-Sale has already been called.");
        require(msg.sender == deployer, "You are not the Seller!");
        // 2. Effects
        ended = true;
